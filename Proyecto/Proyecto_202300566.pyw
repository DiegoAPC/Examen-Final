...
def ventanaRes():
    ...
    txt9.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
...
def ventanadmin():
    ...
    tk.Label(
        fm1, text="ADMINISTRADOR: " + USER_dato, bg="#465051", fg="white", font=("Arial", 32)
    ).pack(expand=True)

    btncerrar = Button(fm1, text="Cerrar Sesión", bg = "RED", fg = "white", command=root.destroy) #BOTÓN CERRAR VENTANA #BOTÓN CONFIRMAR
    ...
    txt10.config(font=('Arial',10),justify=tk.CENTER, bd=2, relief="solid")
    txt10.place(x=140, y=250, width=175, height = 35)
    txt12 = tk.Entry(fm2, bg="white")#DPI
    txt12.config(font=('Arial',10),justify=tk.CENTER, bd=2, relief="solid")
    txt12.place(x=140, y=350, width=175, height = 35)
    txt13 = tk.Entry(fm2, bg="white", show="*")#Contraseña
    txt13.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
    txt13.place(x=140, y=450, width=175, height = 35)
    txt14 = tk.Entry(fm2, bg="white", show="*")#Confirmar contraseña
    txt14.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
    txt14.place(x=140, y=550, width=175, height = 35)

    btn1 = tk.Button(fm2, text="CONFIRMAR", bg = "#0F4296", fg = "white", command=EnviarDatosCat) #BOTÓN CONFIRMAR
    ...
    def ventanaDatosCursos():
        ...
        btn1 = Button(VentanaEditarCursos, text="CONFIRMAR", bg = "#0F4296", fg = "white", command=Vercurso) #BOTÓN CONFIRMAR
        btn1.place(x=250, y=100, width=175, height = 30 )
        btn2 = Button(VentanaEditarCursos, text="Editar", bg = "#0F4296", fg = "white", command=EditarCosto) #BOTÓN CONFIRMAR
        btn2.place(x=250, y=300, width=175, height = 30 )
        btn3 = Button(VentanaEditarCursos, text="Editar", bg = "#0F4296", fg = "white", command=EditarHorario) #BOTÓN CONFIRMAR
        btn3.place(x=250, y=400, width=175, height = 30 )
        btn4 = Button(VentanaEditarCursos, text="Editar", bg = "#0F4296", fg = "white", command=EditarCodigo) #BOTÓN CONFIRMAR
        btn4.place(x=250, y=500, width=175, height = 30 )
        btn5 = Button(VentanaEditarCursos, text="Editar", bg = "#0F4296", fg = "white", command=EditarCupo) #BOTÓN CONFIRMAR
        btn5.place(x=250, y=600, width=175, height = 30 )
        btn6 = Button(VentanaEditarCursos, text="Editar", bg = "#0F4296", fg = "white", command=EditarCat) #BOTÓN CONFIRMAR
    ...
    txt15.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
    txt15.place(x=140, y=220, width=175, height = 35)
    txt16 = tk.Entry(fm3)#Costo del curso
    txt16.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
    txt16.place(x=140, y=320, width=175, height = 35)
    txt17 = tk.Entry(fm3)#Horario del curso
    txt17.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
    txt17.place(x=140, y=420, width=175, height = 35)
    txt18 = tk.Entry(fm3)#Código del curso
    txt18.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
    txt18.place(x=140, y=520, width=175, height = 35)
    txt19 = tk.Entry(fm3)#Cupo del curso
    txt19.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
    txt19.place(x=140, y=620, width=175, height = 35)
    txt20 = tk.Entry(fm3)#Catedrático del curso
    txt20.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
    txt20.place(x=140, y=720, width=175, height = 35)
    btn2 = tk.Button(fm3, text="CONFIRMAR", bg = "#0F4296", fg = "white", command=Crearcurso) #BOTÓN CONFIRMAR
    btn2.place(x=260, y=775, width=175, height = 30 )
    btn2b = tk.Button(fm3, text="Editar Curso", bg = "#0F4296", fg = "white", command=ventanaDatosCursos) #BOTÓN CONFIRMAR
    ...
    def Eliminarcurso():
        ...
        with open("CursosCatedraticos.txt", "w") as archivo:
            # Escribir todas las líneas, excepto la que corresponde al usuario bloqueado
            for linea in lineas:
                # Obtener el usuario dentro del txt
                nombrecurso1 = linea.strip().split(",")

                # Ver si el nombre del usuario es igual al que se desea bloquear
                if nombrecurso1[0] != Cursoeliminar_dato:
                    archivo.write(linea)
        ...
        with open("CursosExistentes.txt", "w") as archivo:
            ...
            for linea in lineas:
                # Obtener el usuario dentro del txt
                nombrecurso2 = linea.strip().split(",")

                # Ver si el nombre del usuario es igual al que se desea bloquear
                if nombrecurso2[0] != Cursoeliminar_dato:
                    archivo.write(linea)
    ...
    txt21.config(font=("Arial",14), bd=2, relief="solid")
    txt21.pack(fill=tk.BOTH, expand=True, padx=(10, 10), pady=(250, 175))
    btn3 = tk.Button(fm4, text="Ver cursos y catedráticos", bg = "#0F4296", fg = "white", command=Vercursos) #BOTÓN ver datos de cursos
    btn3.config(font=("Arial",12))
    btn3.place(x=30, y=700, width=225, height = 30 )
    btn4 = tk.Button(fm4, text="Limpiar contenido", bg = "#0F4296", fg = "white", command=Limpiarcaja) #BOTÓN para limpiar la caja de texto
    ...
    txt20b.config(font=("Arial",10),justify=tk.CENTER, bd=2, relief="solid")
    txt20b.place(x=150, y=750, width=150, height = 30)
    btn4b = tk.Button(fm4, text='Eliminar', bg = "#0F4296", fg = "white", command=Eliminarcurso) #BOTÓN para eliminar curso existente
    ...
    txt22.config(font=("Arial", 14), bd=2, relief="solid")
    txt22.pack(fill=tk.BOTH, expand=True, padx=(10, 10), pady=(300, 300))

    # Entrada y botones
    txt23 = tk.Entry(fm5, bg="white")
    txt23.config(font=("Arial", 10), justify=tk.CENTER, bd=2, relief="solid")
    txt23.place(x=140, y=200, width=175, height=35)
    btn5 = tk.Button(fm5, text="CONFIRMAR", bg="#0F4296", fg="white", command=Buscarcurso)
    btn5.config(font=("Arial", 12))
    btn5.place(x=140, y=250, width=175, height=30)
    btn6 = tk.Button(fm5, text="Limpiar contenido", bg="#0F4296", fg="white", command=Limpiarcaja)
    btn6.config(font=("Arial", 12))
    btn6.place(x=140, y=600, width=175, height=30)


    #Funcion para abrir la ventana para desbloquear cuentas
    def ventanaDesbloquear():
        Ventanadesbloqueo = tk.Toplevel()
        Ventanadesbloqueo.title("EDITAR DATOS DE LOS CURSOS")
        Ventanadesbloqueo.geometry("300x250")

        def Desbloquearcuenta():
            Usuario_dato = txt1.get()

            with open("CuentasBloqueadas.txt", "r") as archivo:
                lineas = archivo.readlines()  # Leer todas las líneas del archivo

            with open("CuentasBloqueadas.txt", "w") as archivo:
                # Escribir todas las líneas, excepto la que corresponde al usuario bloqueado
                for linea in lineas:
                    # Obtener el usuario dentro del txt
                    posicionesc = linea.strip().split(",")

                    # Ver si el nombre del usuario es igual al que se desea bloquear
                    if posicionesc[0] != Usuario_dato:
                        archivo.write(linea)

                    if posicionesc[0] == Usuario_dato:
                        #Guardar usuario en archivo que no permita el acceso
                        newfile = open("UsuariosReg.txt", "a")
                        newfile.write(posicionesc[0])
                        newfile.write(",")
                        newfile.write(posicionesc[1])
                        newfile.write(",")
                        newfile.write(posicionesc[2])
                        newfile.write("\n")
                        newfile.close()
            messagebox.showinfo("HECHO", "Cuenta Desbloqueada")

        lbl1 = Label(Ventanadesbloqueo, text="USUARIO DE LA CUENTA", fg ="black")
        lbl1.config(font=("Arial",10))
        lbl1.place(x=30, y=50, width=250, height = 35)
        txt1 = tk.Entry(Ventanadesbloqueo, bg="white")
        txt1.config(font=("Arial", 10), justify=tk.CENTER, bd=2, relief="solid")
        txt1.place(x=60, y=100, width=175, height=35)
        btn1 = tk.Button(Ventanadesbloqueo, text="DESBLOQUEAR", bg="#0F4296", fg="white", command=Desbloquearcuenta)
        btn1.config(font=("Arial", 12))
        btn1.place(x=60, y=150, width=175, height=30)

    btndes = Button(fm1, text="Desbloquear cuentas", bg = "#0F4296", fg = "white", command=ventanaDesbloquear) #BOTÓN CERRAR VENTANA #BOTÓN CONFIRMAR
    btndes.place(x=20, y=80, width=175, height = 30 )
...
def ventanacat():
    ...
    fm0 = tk.Frame(root, bg="#465051")
    fm0.grid(row=0, column=0, columnspan=3, sticky="nsew")

    fm1 = tk.Frame(root, bg="#E7E7E7")
    fm1.grid(row=1, column=0, sticky="nsew")

    fm2 = tk.Frame(root)
    fm2.grid(row=1, column=1, sticky="nsew")

    fm3 = tk.Frame(root, bg="#E7E7E7")
    fm3.grid(row=1, column=2, sticky="nsew")

    btncerrar1 = Button(fm0, text="Cerrar Sesión", bg = "RED", fg = "white", command=root.destroy) #BOTÓN CERRAR VENTANA #BOTÓN CONFIRMAR
    ...
    def MisCursos():
        ...
        with open("CursosCatedraticos.txt", "r") as archivo:
            for linea in archivo:
                ...
                if Nombrecate == datos2[1]:
                    # Agrega el dato de los cursos a la lista de repeticiones
                    Listacursos.append(datos2[0])

        txt2b.delete(1.0, tk.END)  # Borra cualquier contenido previo
        txt2b.insert(tk.END, "\n".join(Listacursos))
    ...
    with open("DatosUsuarios.txt", "r") as archivo:
        for linea in archivo:
            ...
            if len(datos) <= 5 and USER_dato == datos[1]:
                Nombre = datos[0] 
    #Etiquetas
    lbl0 = tk.Label(fm0, text="Catedratico: " + Nombre, fg ="WHITE", bg="#465051")
    ...
    txt2b.config(font=("Arial",14), bd=2, relief="solid")
    txt2b.place(x=50, y=100, width=350, height = 70)
    btn6 = tk.Button(fm1, text="Ver", bg = "#0F4296", fg = "white", command=MisCursos) #BOTÓN CONFIRMAR
    btn6.place(x=420, y=100, width=175, height = 70 )

    #Caja de texto para ver datos de curso
    txt1a = Text(fm1, bg="White")
    txt1a.config(font=("Arial",14), bd=2, relief="solid")
    ...
    btn1 = tk.Button(fm1, text="CONFIRMAR", bg = "#0F4296", fg = "white", command=Vercurso) #BOTÓN CONFIRMAR
    btn1.place(x=310, y=250, width=175, height = 30 )
    btn2 = tk.Button(fm1, text="Editar", bg = "#0F4296", fg = "white", command=EditarCosto) #BOTÓN CONFIRMAR
    btn2.place(x=310, y=480, width=175, height = 30 )
    btn3 = tk.Button(fm1, text="Editar", bg = "#0F4296", fg = "white", command=EditarHorario) #BOTÓN CONFIRMAR
    btn3.place(x=310, y=580, width=175, height = 30 )
    btn4 = tk.Button(fm1, text="Editar", bg = "#0F4296", fg = "white", command=EditarCodigo) #BOTÓN CONFIRMAR
    btn4.place(x=310, y=680, width=175, height = 30 )
    btn5 = tk.Button(fm1, text="Editar", bg = "#0F4296", fg = "white", command=EditarCupo) #BOTÓN CONFIRMAR
    ...
    def Editarnota():
        ...
        with open("EstudianteCursos.txt", "r") as archivo:
            lineas = archivo.readlines() # Leer todas las líneas del archivo
            
            for i in range(len(lineas)):
                Linea2 = lineas[i].strip() 
                dato1 = Linea2.split(",")
                if dato1[0] == estudianteusuario_dato:
                    dato1[2] = editarnota_dato
                    lineas[i] = ",".join(dato1) + "\n"

        # Escribir todas las líneas, incluida la primera modificada
        with open("EstudianteCursos.txt", "w") as archivo:
            archivo.writelines(lineas)
    ...
    btn6 = tk.Button(fm3, text="CONFIRMAR O ACTUALIZAR", bg="#0F4296", fg="white", command=Buscarcurso)
    btn6.config(font=("Arial", 12))
    btn6.place(x=190, y=200, width=250, height=30)
    btn7 = tk.Button(fm3, text="Limpiar contenido", bg="#0F4296", fg="white", command=Limpiarcaja)
    btn7.config(font=('Arial', 12))
    btn7.place(x=220, y=550, width=175, height=30)

    txt24 = tk.Entry(fm3, bg="white") # Usuario del estudiante
    txt24.config(font=("Arial", 10), justify=tk.CENTER, bd=2, relief="solid")
    txt24.place(x=220, y=650, width=175, height=35)
    txt25 = tk.Entry(fm3, bg="white") # Futura nota del estudiante
    txt25.config(font=("Arial", 10), justify=tk.CENTER, bd=2, relief="solid")
    txt25.place(x=220, y=700, width=175, height=35)
    btn8 = tk.Button(fm3, text="Editar", bg="#0F4296", fg="white", command=Editarnota)
    btn8.config(font=("Arial", 12))
    btn8.place(x=450, y=650, width=100, height=50)


    def MensajeCurso():
        texto = txt27.get("1.0", tk.END)
        NombreCurso3_dato = txt26.get()

        with open(NombreCurso3_dato + ".txt", "r") as archivo:
            lineas = archivo.readlines() # Leer todas las líneas del archivo
            
            Linea = lineas[0].strip()
            dato = Linea.split(",")

            # Modificar la posición 6 del dato con el nuevo texto
            dato[6] = texto
            # Volver a unir la línea y actualizar en la lista de líneas
            lineas[0] = ",".join(dato)


        # Escribir todas las líneas, incluida la primera modificada
        with open(NombreCurso3_dato + ".txt", "w") as archivo:
            archivo.writelines(lineas)

        txt26.delete(0, END)
        txt27.delete(1.0, tk.END)
        messagebox.showinfo("HECHO", "Mensaje actualizado")



    lbl1b = tk.Label(fm2, text="MENSAJE INTRODUCTORIO AL CURSO", fg="white", bg="black", font=("Arial", 12))
    lbl1b.place(x=180, y=50, width=300, height=50)
    lbl2b = tk.Label(fm2, text="Nombre del curso:", fg="white", bg="black", font=("Arial", 10))
    lbl2b.place(x=140, y=150, width=150, height=35)
    txt26 = tk.Entry(fm2, bg="white") # Nombre del curso
    txt26.config(font=("Arial", 10), justify=tk.CENTER, bd=2, relief="solid")
    txt26.place(x=300, y=150, width=175, height=35)
    txt27 = tk.Text(fm2, wrap="word", bg="white", font=("Arial", 14), bd=2, relief="solid", insertborderwidth=4)
    txt27.place(x=75, y=250, width=500, height=150) # Texto para el curso
    btn9 = tk.Button(fm2, text="Modificar", bg="#0F4296", fg="white", command=MensajeCurso)
    btn9.config(font=("Arial", 12))
    btn9.place(x=260, y=420, width=100, height=50)
...
def ventanaest():
    ...
    btncerrar3 = Button(fm0, text="Cerrar Sesión", bg = "RED", fg = "white", command=root.destroy) #BOTÓN CERRAR VENTANA #BOTÓN CONFIRMAR
    ...
    lbl1f = tk.Label(fm0, text="ESTUDIANTE: " + Nombre, fg="WHITE", bg="#465051", font=("Arial", 26))
    ...
    def asignarcurso():
        ...
        CursoAsignado_dato = txt24.get()
        
        with open(CursoAsignado_dato + ".txt", 'r') as archivo:
            lineas = archivo.readlines()
            for linea in lineas:
                if USER_dato in linea:
                    messagebox.showinfo("CURSO ASIGNADO", "No puede asignarse el mismo curso dos veces seguidas")
                    break
            else:
                #Almacenar datos de usuario a una variable
                with open("DatosUsuarios.txt", "r") as archivo:
                    for linea in archivo:
                        datos = linea.strip().split(",")
                        if len(datos) >= 6 and USER_dato == datos[5]:
                            DatosEstu = datos[0] + "," + datos[1] + "," + datos[5] + "," + "100"

                #Unir datos anteriores con el cupo del estudiante
                with open(CursoAsignado_dato + ".txt", "r") as archivo:
                    lineas = archivo.readlines()
                ...
                # Imprimir todo al archivo de texto
                abrirdoc = open(CursoAsignado_dato + ".txt", "a")
                abrirdoc.write("\n")
                abrirdoc.write(asignacion)
                abrirdoc.close()
                
                # Tener el dato de la nota en una variable
                with open(CursoAsignado_dato + ".txt", "r") as archivo:
                    for linea in archivo:
                        datos = linea.strip().split(",")
                        if len(datos) >= 4 and USER_dato == datos[2]:
                            nota1 = datos[3]

                #Colocar la nota del estudiante
                abrirdoc2 = open("EstudianteCursos.txt", "a")
                abrirdoc2.write(USER_dato + "," + CursoAsignado_dato + "," + nota1)
                abrirdoc2.write("\n")
                abrirdoc2.close()

                messagebox.showinfo("HECHO", "Curso Asignado con exito")
                txt24.delete(0, END)


    # Escoger curso para asignarse
    lbl5f = tk.Label(fm2, text="Nombre del curso:", fg="black", bg="white", font=("Arial", 12))
    lbl5f.place(x=50, y=450, width=150, height=35)
    txt24 = tk.Entry(fm2, bg="white")
    txt24.config(font=("Arial", 10), justify=tk.CENTER, bd=2, relief="solid")
    txt24.place(x=220, y=450, width=175, height=35)
    btn1b = tk.Button(fm2, text="Asignar", bg = "#0F4296", fg = "white", command=asignarcurso)#BOTÓN asignar curso
    btn1b.place(x=420, y=450, width=105, height = 35)


    # Función para enseñar los cursos
    def Cursosdis():

        with open("CursosExistentes.txt", "r") as archivo:
            contenido = archivo.read()
            txt23.delete(1.0, tk.END)  # Borra cualquier contenido previo
            txt23.insert(tk.END, contenido)

    # Caja de texto para mostrar los cursos disponibles
    txt23 = tk.Text(fm2, bg="White")
    txt23.config(font=("Arial", 14), bd=2, relief="solid")
    txt23.place(x=30, y=200, width=400, height=200)
    lbl6f = tk.Label(fm2, text="Cursos Disponibles", fg="black", bg="white", font=("Arial", 12))
    lbl6f.place(x=230, y=100, width=200, height=50)
    btn2b = tk.Button(fm2, text="Ver cursos", bg = "#0F4296", fg = "white", command=Cursosdis)#BOTÓN para ver cursos disponibles
    btn2b.place(x=450, y=200, width=175, height = 50)



    #Ventana de los cursos (Ventana unica, que luego se personalizara)
    def ventanacursoo():
        NombreCurso4_dato = txt26.get()

        with open(NombreCurso4_dato + ".txt", 'r') as archivo:
            lineas = archivo.readlines()
            for linea in lineas:
                if USER_dato in linea:
                    ventanaCurso = tk.Toplevel()
                    ventanaCurso.title("BIENVENIDO")
                    ventanaCurso.state("zoomed")

                    # Caja de texto para mel mensaje de personalizado a cada clase
                    txt26b = tk.Text(ventanaCurso, bg="White")
                    txt26b.config(font=("Arial", 30))
                    txt26b.place(x=200, y=100, width=1500, height=400)
                    ...
                    txt26b.delete(1.0, tk.END)  # Borra cualquier contenido previo
                    txt26b.insert(tk.END, dato[6])
                    ...
                    lbl1 = tk.Label(ventanaCurso, text="Nota del curso: " + nota, fg="black", bg="white", font=("Arial", 16))
                    lbl1.place(x=550, y=600, width=200, height=50)

                    btncerrar4 = Button(ventanaCurso, text="Cerrar", bg = "black", fg = "white", command=ventanaCurso.destroy) #BOTÓN CERRAR VENTANA #BOTÓN CONFIRMAR
                    btncerrar4.place(x=20, y=20, width=175, height = 30 )
                    break
            else:
                messagebox.showinfo("CURSO NO DISPONIBLE", "No se encuentra asignado al curso")
    ...
    def MisCursosest():
        # Lista para almacenar repeticiones
        Listacursos = []

        with open("EstudianteCursos.txt", "r") as archivo:
            for linea in archivo:
                datos = linea.strip().split(",")
                if len(datos) >= 2 and USER_dato == datos[0]:
                    # Agrega el segundo dato a la lista de repeticiones
                    Listacursos.append(datos[1])


        txt25b.delete(1.0, tk.END)  # Borra cualquier contenido previo
        txt25b.insert(tk.END, "\n".join(Listacursos))

    # Caja de texto para mostrar los cursos asignados
    txt25b = tk.Text(fm1, bg="White")
    txt25b.config(font=("Arial", 14), bd=2, relief="solid")
    txt25b.place(x=200, y=300, width=350, height=200)
    lbl7f = tk.Label(fm1, text="Mis cursos", fg="black", bg="white", font=("Arial", 12))
    lbl7f.place(x=270, y=150, width=200, height=50)
    btn3b = tk.Button(fm1, text="Ver Mis Cursos", bg = "#0F4296", fg = "white", command=MisCursosest)#BOTÓN para ver cursos disponibles
    btn3b.place(x=280, y=225, width=175, height = 50)
    txt25 = tk.Entry(fm2, bg="white")
    txt25.config(font=("Arial", 10), justify=tk.CENTER, bd=2, relief="solid")
    txt25.place(x=700, y=250, width=175, height=35)


    lbl8f = tk.Label(fm1, text="Entrar al curso:", fg="black", bg="white", font=("Arial", 12))
    lbl8f.place(x=600, y=300, width=170, height=50)
    btn4b = tk.Button(fm1, text="Entrar", bg = "#0F4296", fg = "white", command=ventanacursoo)#BOTÓN para abrir la ventana del curso
    btn4b.place(x=980, y=300, width=170, height = 50)
    txt26 = tk.Entry(fm1, bg="white")
    txt26.config(font=("Arial", 10), justify=tk.CENTER, bd=2, relief="solid")
    txt26.place(x=790, y=300, width=170, height=50)

    # Función para borrar el registro de asignación del estudiante del curso (Desasignar)
    def Desasignarcurso():
        DesasignarCurso_dato = txt27c.get()



        with open(DesasignarCurso_dato + ".txt", "r") as archivo:
            lineas = archivo.readlines()  # Leer todas las líneas del archivo

        with open(DesasignarCurso_dato + ".txt", "w") as archivo:
            # Escribir todas las líneas, excepto la que corresponde al usuario bloqueado
            for linea in lineas:
                # Obtener el usuario dentro del txt
                nombrecurso3 = linea.strip().split(",")

                # Ver si el nombre del usuario es igual al que se desea bloquear
                if nombrecurso3[2] != USER_dato:
                    archivo.write(linea)

        with open("EstudianteCursos.txt", "r") as archivo:
            lineasb = archivo.readlines()  # Leer todas las líneas del archivo

        with open("EstudianteCursos.txt", "w") as archivo:
            # Escribir todas las líneas, excepto la que corresponde al usuario bloqueado
            for linea in lineasb:
                # Obtener el usuario dentro del txt
                datos0 = linea.strip().split(",")

                # Ver si el nombre del usuario es igual al que se desea bloquear
                if datos0[0] != USER_dato and datos0[1] != DesasignarCurso_dato:
                    archivo.write(linea)


        #Limpiar en entry una vez hecho todo
        txt27c.delete(0, tk.END)
        #Mensaje de error su no esta en archivo o curso
        messagebox.showinfo("HECHO", "Desasignación del curso exitosa")

    lbl8g = tk.Label(fm1, text="Desasignar curso:", fg="black", bg="white", font=("Arial", 12))
    lbl8g.place(x=600, y=500, width=170, height=50)
    btn4c = tk.Button(fm1, text="Desasignar", bg = "#0F4296", fg = "white", command=Desasignarcurso)#BOTÓN para abrir la ventana del curso
    btn4c.place(x=980, y=500, width=170, height = 50)
    txt27c = tk.Entry(fm1, bg="white")
    txt27c.config(font=("Arial", 10), justify=tk.CENTER, bd=2, relief="solid")
    txt27c.place(x=790, y=500, width=170, height=50)


    #btn10 = tk.Button(fm0, text="Editar Foto de Perfil", bg="#0F4296", fg="white", command=Editarcuentaest)
    #btn10.config(font=("Arial", 10))
    #btn10.place(x=20, y=70, width=175, height=50)
...
def confirmaruser():
    ...
    if not USER_dato or not CONT_dato:
        messagebox.showerror("DATOS INCOMPLETOS", "Ingrese su usuario y contraseña")
        return
    ...
    if intentos == 2:
        messagebox.showerror("CUIDADO", "Al siguiente intento fallido la cuenta será bloqueada")
    ...
    if intentos == 3:
        ...
        with open("UsuariosReg.txt", "w") as archivo:
            # Escribir todas las líneas, excepto la que corresponde al usuario bloqueado
            for linea in lineas:
                # Obtener el usuario dentro del txt
                posicionesc = linea.strip().split(",")
                ...
                # Ver si el nombre del usuario es igual al que se desea bloquear
                if posicionesc[0] != USER_dato:
                    archivo.write(linea)

                if posicionesc[0] == USER_dato:
                    #Guardar usuario en archivo que no permita el acceso
                    newfile = open("CuentasBloqueadas.txt", "a")
                    newfile.write(posicionesc[0])
                    newfile.write(",")
                    newfile.write(posicionesc[1])
                    newfile.write(",")
                    ...
                    newfile.write("\n")
                    newfile.close()
        messagebox.showerror("BLOQUEADO", "La cuenta ha sido bloqueada, notificar al administrador")
...
txt1.config(font=("Arial",14),justify=tk.CENTER, bd=2, relief="solid") 
txt1.place(relx=0.25, rely=0.30, relwidth=0.5, relheight = 0.1)
txt2 = Entry(programa, textvariable=CONT, show="*")
txt2.config(font=("Arial",14),justify=tk.CENTER, bd=2, relief="solid")
txt2.place(relx=0.25, rely=0.50, relwidth=0.5, relheight = 0.1)
btn1 = Button(programa, text="CONFIRMAR", bg = "#0F4296", fg = "white", command=confirmaruser) #BOTÓN CONFIRMAR
...
btn4 = Button(programa, text="REGISTRARSE", bg = "#0F4296", fg = "white", command=ventanaRes)#BOTÓN REGISTRAR ESTUDIANTES
